...
- A compatible microcontroller
	...
	- Arduino or Arduino Compatible MBED microcontroller (alternative/legacy)
...
### ESP32-P4 (e.g. Waveshare ESP32-P4-WiFi6-Touch-LCD-7B) — Recommended
...
## Arduino / Mbed Pin Mapping (alternative/legacy boards)
...
AC Infinity uses an industrial 10V PWM standard while most microcontroller boards output 3.3V or 5V PWM logic. You will need to interpose a bi-directional level logic shifter to ensure the AC Infinity blower runs at full performance.
...
PC fans use the 5V PWM standard as outlined in the [PWM White Paper by Noctua](https://cdn.noctua.at/media/Noctua_PWM_specifications_white_paper.pdf). Most ESP32 boards output 3.3V logic, so you will need to interpose a bi-directional level logic shifter to ensure full performance.
